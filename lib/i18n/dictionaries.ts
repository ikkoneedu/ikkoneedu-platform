...
import * as schoolLife from "@/lib/i18n/dict/schoolLife";
...
import * as staffOps from "@/lib/i18n/dict/staffOps";
...
const ZONE_TR: Dict[] = [
  ...
  attendance.tr, staffCard.tr, staffOps.tr,
];
const ZONE_EN: Dict[] = [
  ...
  attendance.en, staffCard.en, staffOps.en,
];
...
const tr: Dict = {
  ...
  // Giriş — telefon (SMS) sekmesi
  "login.tabEmail": "E-posta",
  "login.tabPhone": "Telefon",
  "login.phoneLabel": "Telefon numarası",
  "login.phonePlaceholder": "05xx xxx xx xx",
  "login.phoneHint": "Numaranıza SMS ile 6 haneli bir doğrulama kodu göndereceğiz.",
  "login.phoneSend": "Kod gönder",
  "login.phoneSending": "Gönderiliyor...",
  "login.phoneCodeLabel": "SMS doğrulama kodu",
  "login.phoneVerify": "Doğrula ve Giriş Yap",
  "login.phoneVerifying": "Doğrulanıyor...",
  "login.phoneResend": "Kodu tekrar gönder",
  "login.phoneChange": "Numarayı değiştir",
  "login.phoneInvalid": "Geçerli bir telefon numarası girin (örn. 05xx xxx xx xx).",
  "login.phoneUnavailable": "Telefonla giriş şu anda kullanılamıyor. Lütfen e-posta ile giriş yapın.",
  "login.phoneNotEnabled": "Telefonla giriş henüz etkin değil. Yöneticinizle iletişime geçin.",
  "login.phoneCodeError": "Kod hatalı veya süresi dolmuş. Lütfen tekrar deneyin.",
  "login.phoneNoAccount": "Bu numara bir hesaba bağlı değil. Önce e-posta ile giriş yapıp profil sayfanızdan telefonunuzu doğrulayın.",

  // Profil — telefonu doğrula/bağla (Firebase Phone Auth)
  "linkPhone.title": "Telefonu doğrula",
  "linkPhone.desc": "Telefonunuzu doğrulayarak SMS koduyla da giriş yapabilirsiniz.",
  "linkPhone.verified": "Doğrulandı",
  "linkPhone.notVerified": "Doğrulanmadı",
  "linkPhone.phoneLabel": "Telefon numarası",
  "linkPhone.phonePlaceholder": "05xx xxx xx xx",
  "linkPhone.send": "Doğrulama kodu gönder",
  "linkPhone.sending": "Gönderiliyor...",
  "linkPhone.codeLabel": "SMS kodu",
  "linkPhone.confirm": "Doğrula",
  "linkPhone.confirming": "Doğrulanıyor...",
  "linkPhone.change": "Numarayı değiştir",
  "linkPhone.success": "Telefon numaranız doğrulandı.",
  "linkPhone.invalid": "Geçerli bir telefon numarası girin (örn. 05xx xxx xx xx).",
  "linkPhone.unavailable": "Telefon doğrulama şu anda kullanılamıyor.",
  "linkPhone.alreadyInUse": "Bu numara başka bir hesaba bağlı. Farklı bir numara deneyin.",
};
...
const en: Dict = {
  ...
  "login.phonePlaceholder": "05xx xxx xx xx",
  "login.phoneHint": "We'll send a 6-digit verification code to your number via SMS.",
  "login.phoneSend": "Send code",
  "login.phoneSending": "Sending...",
  "login.phoneCodeLabel": "SMS verification code",
  "login.phoneVerify": "Verify and Sign In",
  "login.phoneVerifying": "Verifying...",
  "login.phoneResend": "Resend code",
  "login.phoneChange": "Change number",
  "login.phoneInvalid": "Enter a valid phone number (e.g. 05xx xxx xx xx).",
  "login.phoneUnavailable": "Phone sign-in is currently unavailable. Please sign in with email.",
  "login.phoneNotEnabled": "Phone sign-in is not enabled yet. Please contact your administrator.",
  "login.phoneCodeError": "The code is incorrect or expired. Please try again.",
  "login.phoneNoAccount": "This number is not linked to an account. Sign in with email first and verify your phone from your profile page.",

  // Profile — verify/link phone (Firebase Phone Auth)
  "linkPhone.title": "Verify phone",
  "linkPhone.desc": "Verify your phone to also sign in with an SMS code.",
  "linkPhone.verified": "Verified",
  "linkPhone.notVerified": "Not verified",
  "linkPhone.phoneLabel": "Phone number",
  "linkPhone.phonePlaceholder": "05xx xxx xx xx",
  "linkPhone.send": "Send verification code",
  "linkPhone.sending": "Sending...",
  "linkPhone.codeLabel": "SMS code",
  "linkPhone.confirm": "Verify",
  "linkPhone.confirming": "Verifying...",
  "linkPhone.change": "Change number",
  "linkPhone.success": "Your phone number has been verified.",
  "linkPhone.invalid": "Enter a valid phone number (e.g. 05xx xxx xx xx).",
  "linkPhone.unavailable": "Phone verification is currently unavailable.",
  "linkPhone.alreadyInUse": "This number is linked to another account. Try a different number.",
};
