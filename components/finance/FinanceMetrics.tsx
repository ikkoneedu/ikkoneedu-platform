...
import type { FinanceMetric } from "@/lib/finance-mock-data";

interface FinanceMetricsProps {
  metrics: FinanceMetric[];
}

const TREND_STYLES: Record<NonNullable<FinanceMetric["trend"]>, string> = {
  up: "text-emerald-400",
  down: "text-brand",
  neutral: "text-muted",
};

const TREND_ICON: Record<NonNullable<FinanceMetric["trend"]>, LucideIcon> = {
  up: TrendingUp,
  down: TrendingDown,
  neutral: Minus,
};
...
/**
 * Finans özet metrik kartları.
 */
export function FinanceMetrics({ metrics }: FinanceMetricsProps) {
  return (
