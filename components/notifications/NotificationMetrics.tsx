...
import type { NotificationMetric } from "@/lib/notifications-mock-data";
...
/**
 * Bildirim Genel Metrikleri.
 */
export function NotificationMetrics({ metrics }: NotificationMetricsProps) {
  return (
      ...
      {metrics.map((metric) => {
        ...
        return (
          <GlassCard key={metric.id} tone="navy" interactive className="p-4">
            ...
            <p className="mt-3 text-2xl font-bold tracking-tight text-content">{metric.value}</p>
