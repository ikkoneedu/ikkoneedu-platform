        ...
        <form onSubmit={add} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-1.5 sm:col-span-2">
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-content placeholder:text-muted/60 outline-none focus:border-accent focus:ring-1 focus:ring-accent"
            />
          </div>
          <div>
