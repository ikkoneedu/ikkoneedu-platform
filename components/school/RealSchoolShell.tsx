...
/**
 * Gerçek okul (tenant) için halka açık kabuk: tenant'ı yükler, marka başlığı ve
 * altbilgiyi sağlar; yükleme/bulunamadı durumlarını yönetir. İçeriği render
 * prop ile yüklü okul kaydını alarak çizer.
 */
export function RealSchoolShell({
  slug,
  children,
}: {
  slug: string;
  children: (school: SchoolRecord) => ReactNode;
}) {
