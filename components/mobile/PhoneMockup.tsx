...
export function PhoneMockup({ children, className = "" }: PhoneMockupProps) {
  return (
    <div className={`relative mx-auto w-[250px] max-w-full ${className}`}>
      ...
      {/* Gövde */}
      <div className="rounded-[2.6rem] border border-overlay/15 bg-gradient-to-b from-overlay/10 to-overlay/[0.02] p-2.5 shadow-[0_20px_60px_rgba(0,0,0,0.5)] backdrop-blur-xl">
        {/* Ekran */}
        <div className="relative aspect-[9/19] overflow-hidden rounded-[2.1rem] border border-overlay/10 bg-background">
          {/* Çentik */}
